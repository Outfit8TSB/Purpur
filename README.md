...
## Purpur(NogyangSpigot Library)

This Code will be only be used for future purpur based forks like those.
GAME-CLI-SRV-DEV CrystalMC (SugarcaneMC)
GAME-CLI-SRV-DEV SugarcaneMCImproved

>The Airplane Patch Will Be Removed in the future
>By The Favor of NogyangSpigot-Airplane.patch
